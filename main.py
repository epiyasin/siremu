...
if __name__ == "__main__":
    ...
    if settings.execution_source == "MINT":
        ...
        if settings.mode == "comparison":
            ...
            emulation_input = torch.tensor([settings.abm_scenario], dtype=torch.float32)
