...
def plot_comparison(predictions, actual, ABM_data, settings):
    ...
    fig, axes = plt.subplots(int(num_plots**0.5), int(num_plots**0.5), figsize=settings.figure_size_comparison)
...
def plot_emulation(predicted_output, settings):
    plt.figure(figsize=settings.figure_size_emulation)
